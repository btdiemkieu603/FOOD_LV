    ...
    const actionColumn = [
        {
            ...
            renderCell: (params) => {
                ...
                const customerDetailLink = role === "admin"
                    ? `/admin/customerManagement/customerDetail/${params.row.id}`
                    : `/staff/customerManagement/customerDetail/${params.row.id}`;

                return (
                    <div className="cellAction">
                        {/* <div className="viewButton">           handleLockUnlock(params.row.id, currentStatus)} */}

                        {/* </div> */}
                        <Link to={customerDetailLink} style={{ textDecoration: "none" }}>
                        ...
                        {/* <Link to={`/customerManagement/editCustomer/${params.row.id}`} className="editButton" style={{ textDecoration: "none" }}>
                            <EditIcon />
                        </Link> */}
