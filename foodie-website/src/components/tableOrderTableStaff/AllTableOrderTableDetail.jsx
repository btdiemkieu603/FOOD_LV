...
const AllTableOrderTableDetail = () => {
    ...
    const filteredData = dataAll.filter(order => {
        ...
        const isOrderPlaced = order.orderStatusId === 3; // Kiểm tra trạng thái là "Đặt món"
        const isMatchingTable = order.table?.tableId.toString() === tableId; // Kiểm tra bàn khớp


        return isInSearchTerm && isInSearchStatus && isInSearchTable && isOrderPlaced && isMatchingTable;;
    });
...
export default AllTableOrderTableDetail;
